// Persistent-разрешения на инструменты — какие tools пользователь раз и
// навсегда разрешил. Хранятся в os.UserConfigDir()/execai/permissions.json,
// чтобы переживать рестарты CLI.
//
// Формат:
//   {
...
// LoadPermissions читает permissions.json. Если файла нет — возвращает пустые
// разрешения с готовым путём для последующего Save.
