// Welcome screen — onboarding при первом запуске. Маркер `.welcome_seen` в
// директории конфига. После первого показа создаётся, и follow-up запуски
// пропускают приветствие.
package welcome
...
// MaybeWelcome возвращает текст приветствия при ПЕРВОМ запуске, иначе пустую
// строку. Маркер пишется сразу при показе.
