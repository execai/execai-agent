...
var zhSubsMessages = map[string]string{
	...
	"subs.connect.zaiApiRejected": "✗ api.z.ai 拒绝了该密钥（HTTP %d）。\n" +
		"你可能填入了 GLM Coding Plan 的密钥，而不是开放平台的密钥。\n" +
		"\n" +
		"两种密钥并不相同：\n" +
		"  • GLM Coding Plan（订阅）：  /connect zai <key>      — 见 https://z.ai/manage-apikey/subscription\n" +
		"  • 开放平台（按量计费）：      /connect zai-api <key>  — 见 https://z.ai/manage-apikey/apikey-list",
