...
var esSubsMessages = map[string]string{
	...
	"subs.connect.zaiApiRejected": "✗ clave rechazada por api.z.ai (HTTP %d).\n" +
		"Puede que hayas pegado una clave del GLM Coding Plan en lugar de la del open platform.\n" +
		"\n" +
		"Son claves distintas:\n" +
		"  • GLM Coding Plan (suscripción): /connect zai <clave>      — en https://z.ai/manage-apikey/subscription\n" +
		"  • Open platform (por tokens):    /connect zai-api <clave>  — en https://z.ai/manage-apikey/apikey-list",
