...
var enSubsMessages = map[string]string{
	...
	"subs.connect.zaiApiRejected": "✗ key rejected by api.z.ai (HTTP %d).\n" +
		"You may have pasted a GLM Coding Plan key instead of an open-platform one.\n" +
		"\n" +
		"The keys are different:\n" +
		"  • GLM Coding Plan (subscription): /connect zai <key>      — from https://z.ai/manage-apikey/subscription\n" +
		"  • Open platform (pay-per-token):  /connect zai-api <key>  — from https://z.ai/manage-apikey/apikey-list",
