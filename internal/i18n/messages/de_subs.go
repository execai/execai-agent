...
var deSubsMessages = map[string]string{
	...
	"subs.connect.zaiApiRejected": "✗ Schlüssel von api.z.ai abgelehnt (HTTP %d).\n" +
		"Möglicherweise hast du einen GLM-Coding-Plan-Schlüssel statt eines Open-Platform-Schlüssels eingefügt.\n" +
		"\n" +
		"Die Schlüssel sind verschieden:\n" +
		"  • GLM Coding Plan (Abo):        /connect zai <key>      — von https://z.ai/manage-apikey/subscription\n" +
		"  • Open Platform (pro Token):    /connect zai-api <key>  — von https://z.ai/manage-apikey/apikey-list",
