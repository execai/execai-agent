...
var deSubsMessages = map[string]string{
	...
	"subs.provider.openrouter": "OpenRouter (sk-or-… von openrouter.ai — alle Anbieter mit einem Key, Pay-per-Token)",
	...
	"subs.connectHint.openrouter": "OpenRouter Pay-per-Token: Claude, GPT, Gemini, DeepSeek mit einem Key",
	...
	"subs.connect.example.openrouter": "Beispiel: /connect openrouter sk-or-v1-XXXXX  (Key von https://openrouter.ai/keys)",
	...
	"subs.connect.openrouterRejected": "✗ Key von openrouter.ai abgelehnt (HTTP %d).\n  Du brauchst einen sk-or-… Key von https://openrouter.ai/keys.",
}
