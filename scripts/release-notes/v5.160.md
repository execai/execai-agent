...
**Manual download** — [all binaries for this release](https://github.com/execai/execai-agent/releases/tag/v5.160): `linux-amd64`, `linux-arm64`, `darwin-amd64`, `darwin-arm64`, `windows-amd64`, `windows-arm64`, plus `SHA256SUMS` to verify.
