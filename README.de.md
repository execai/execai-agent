...
Du kannst alle deine Agenten anzeigen und einzelne entkoppeln unter `apidev.velesbsd.com/settings/agents` (im UserMenu unten links → "Agents", Terminal-Icon).
...
| **WebFetch** | HTTP GET einer Seite (kein JS-Rendering) |
...
| **reference** | Zeiger auf externe Systeme | "Jenkins: jenkins.velesbsd.com, dashboards in Grafana" |
