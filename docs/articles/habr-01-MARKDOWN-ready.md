...
![/source — пикер провайдеров: 9 источников со статусами подключения](https://habrastorage.org/getpro/habr/upload_files/400/ca1/f46/400ca1f4643f4edf5e514326aceae9e6.png)
...
![GLM-5.2 через Ollama Cloud отвечает на вопрос про interface в Go — виден reasoning](https://habrastorage.org/getpro/habr/upload_files/725/93f/f1c/72593ff1cf9831372cea38663e5f9567.png)
...
![/usage — живые квоты Kimi Code: тариф K3+HighSpeed, недельный лимит 48%, rolling 5ч окно](https://habrastorage.org/getpro/habr/upload_files/140/158/944/140158944ac7d7b0be386cb9718cd60f.png)
...
![Kimi K3 проверяет живой Kubernetes-кластер: 5 нод Ready, 89 подов Running](https://habrastorage.org/getpro/habr/upload_files/0b3/39c/eb6/0b339ceb6a257346bc95cac22ef9f35b.png)
